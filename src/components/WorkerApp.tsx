          ...
          <Card className="border-0 shadow-xl bg-white/90 backdrop-blur">
            ...
            <CardContent className="space-y-5 px-4 sm:px-6 pb-4 sm:pb-6">
              <div className="space-y-2">
                <Label htmlFor="firstName" className="text-base sm:text-lg font-medium text-gray-700">
                  First Name
                </Label>
                <Input
                  id="firstName"
                  ...
                  className="border-2 focus:border-blue-500 h-12 sm:h-14 text-base sm:text-lg px-4"
                />
              </div>
              <div className="space-y-2">
                <Label htmlFor="lastName" className="text-base sm:text-lg font-medium text-gray-700">
                  Last Name
                </Label>
                <Input
                  id="lastName"
              ...
              <Button
                ...
                className="w-full py-4 sm:py-5 text-base sm:text-lg font-semibold bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700"
              >
                Continue
              </Button>
            </CardContent>
